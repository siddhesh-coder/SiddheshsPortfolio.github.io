...
const sendEmail = (e) =>{
    ...
    if(contactName.value === '' || contactEmail.value === '' || contactMessage.value === ''){
        ...
        contactNotification.classList.remove('color-remove')
        contactNotification.classList.add('color-add')
        ...
        emailjs.sendForm('service_5ajudf5','template_nlq6v2g','#contact-form','alB48Dr-_xxUNcb0I')
           .then(() =>{
               contactNotification.classList.add('color-blue')
               contactNotification.textContent = 'Message sent ✅'
